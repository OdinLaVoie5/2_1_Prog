...
var arrMemoryIdentific = []; ////////////////  ПАМЯТЬ   ???  есть ли выгода во времени. изменить?  +история? 
var memoryRezSmall = "";
...
// -----------------------------------------------------------------
	...
	if (arrMemoryIdentific[arrMemoryIdentific.length - 1] == identific) return;     // ???  обрыв расчетов если в ПАМЯТИ уже есть данный случай.
...
//[" "    numAll,  i,  word,  j,   partWord0, partWord1, partWord2,     fncName,     k, m,  act     " "]
	...
	arrMemoryIdentific.push(identific);        /////////////////// В ПАМЯТЬ     
