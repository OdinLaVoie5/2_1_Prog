...
function HideFeedback(){
	...
	if (Finished == true){
		Finish();
		alert ("!!!!!!!!!!!");  // my my  действия при победе  ??? 
	}
}
...
function PageDim(){
//Get the page width and height           my   размеры всплыв окна  ???  или нет?
	this.W = 1600;
	this.H = 600;
...
function GetPageXY(El) {   //    ??? не понял! её никто не вызывает
	var XY = {x: 0, y: 0};
	while(El){
		XY.x += El.offsetLeft;
		XY.y += El.offsetTop;
...
//CODE FOR AVOIDING LOSS OF DATA WHEN BACKSPACE KEY INVOKES history.back()       my  для IE 
var InTextBox = false;   //////////////////////
...
function Finish(){
//If there's a form, fill it out and submit it          Если есть форма, заполните ее и представьте её.
...
var NextCorrect = '&#x0414;&#x043E;&#x0431;&#x0430;&#x0432;&#x0438;&#x0442;&#x044C; &#x0432;&#x0435;&#x0440;&#x043D;&#x043E;&#x0435; &#x0441;&#x043B;&#x043E;&#x0432;&#x043E;: ';
...
//This recursive function spreads out the Cards on a line if two of them are overlapping;      my   если на линии две карты накладываются;
