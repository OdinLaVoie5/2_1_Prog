...
function openProper0(){      
	...
	if (option0.style.visibility == "visible") {
		option0.style.visibility = "hidden";
		if(option1.style.visibility == "visible") {
			option1.style.visibility = "hidden";
			if(option2.style.visibility == "visible") {
				option2.style.visibility = "hidden";
				if(option3.style.visibility == "visible") {
...
function openProper3(){      
	var option3 = document.getElementById("option3"); 
	if (option3.style.visibility == "visible") {option3.style.visibility ="hidden"}
	else {option3.style.visibility = "visible";}
...
function jock1(){
	document.getElementById("butjock0").style.visibility = "hidden"; 
	document.getElementById("butjock1").style.visibility = "hidden";
