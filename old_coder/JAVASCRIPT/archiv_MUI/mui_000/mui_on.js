...
function MUI (){	
	...
	resetClon(); // относится к панели настроек
...
function openProper0(){     
	...
	if (option0.style.top == "0px") {
		option0.style.top = "-1500px";
		if(option1.style.top == "0px") {
			option1.style.top = "-1500px";
			if(option2.style.top == "0px") {
				option2.style.top = "-1500px";
				if(option3.style.top == "0px") {
					option3.style.top = "-1500px";
				}
			}
		}
	}
	else {
		option0.style.top = "0px";
		if (flagProper1){
			option1.style.top = "0px";
			if (flagProper2){
				option2.style.top = "0px";
				if (flagProper3){
					option3.style.top = "-300px";
				}
			}
		}
	}
...
function openProper1(){      
	...
	var butadd0 = document.getElementById("butadd0"); 
	if (butadd0.value == "Расширенные") butadd0.value = "Основные"
	else  butadd0.value = "Расширенные";
}
...
function openProper3(){      
	var option3 = document.getElementById("option3"); 
	if (option3.style.top == "-300px") {option3.style.top ="-1500px"}
	else {option3.style.top = "-300px";}
...
function openAllProper0(){
	if(!flagProper0){
		document.getElementById("option0").style.top = "0px"; 
		document.getElementById("option1").style.top = "0px"; 
		document.getElementById("option2").style.top = "0px"; 
		document.getElementById("option3").style.top = "-300px"; 
		flagProper0 = 1;
		flagProper1 = 1;
		flagProper2 = 1;
		flagProper3 = 1;
		...
		document.getElementById("option0").style.top = "-1500px"; 
		document.getElementById("option1").style.top = "-1500px"; 
		document.getElementById("option2").style.top = "-1500px"; 
		document.getElementById("option3").style.top = "-1500px"; 
		flagProper0 = 0;
		flagProper1 = 0;
		flagProper2 = 0;
		flagProper3 = 0;
...
//////////  функция для кнопки "сброс"  (подсверждение сброса, имитация клика скрытой кнопки "reset") ////////
//   ##приём my   !!!
function resetClon(){                
	var arrReset = document.getElementsByClassName("butreset"); 
	for (var i=0; i < arrReset.length; i++) {
		arrReset[i].onclick = function () {
			var con = confirm("Сбросить?");
			if (con) {
				var but = "but" + this.id; 
				var butReset = document.getElementById(but);
				butReset.click();
			}
		}; 	
	};
...
// шутка ха-ха
function jock1(){
	document.getElementById("butjock0").style.display = "none"; 
	document.getElementById("butjock1").style.display = "none";
