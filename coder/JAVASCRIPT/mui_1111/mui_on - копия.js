...
alert (arrRezSmall)
			memoryRezSmall = textsmall.innerHTML = "<table>" + arrRezSmall.join("") + "</table>";
		};
	...
	// ##jq  ##trigger  ##dblclick 
	if (fin) {
		$(fin).trigger("dblclick"); // имитирует двойной клик !!!
...
/*	if (document.getElementById(fin)) {
		...
		$(elemFin).trigger("dblclick"); // имитация двойного клика !!!
	}
*/}
