...
function MUI (){	
	...
	document.getElementById("textup21").innerHTML="";// сброс прежнего результата
	document.getElementById("textup11").innerHTML="";// сброс прежнего результата
	document.getElementById("textsmall").innerHTML="";// сброс прежнего результата
