...
var arrMemoryRez = []; // для краткого вывода.  избегать повтора предыдущ.
...
function MUI (){	
	...
	var arrShow = document.getElementsByName("type_show"),  flagShow = 1;
	...
	if (arrMemoryRez[identific]) {                 /////////////////// ИЗ ПАМЯТИ     
		arrRez = arrMemoryRez[identific][0];
		infoMaxMin = arrMemoryRez[identific][1];
	...
	arrMemoryRez[identific] = [arrRez, infoMaxMin]; /////////////////// В ПАМЯТЬ     
...
function resetConfirm(){                
	if (window.confirm("Сбросить настройки?")) {
